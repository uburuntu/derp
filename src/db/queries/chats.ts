...
export async function upsertChat(
    ...
    const [row] = await db
        ...
        .values({
            ...
            firstName:
                "first_name" in tgChat ? (tgChat.first_name ?? null) : null,
        ...
        .onConflictDoUpdate({
            ...
            set: {
                ...
                title: "title" in tgChat ? (tgChat.title ?? null) : null,
                username:
                    "username" in tgChat ? (tgChat.username ?? null) : null,
                firstName:
                    "first_name" in tgChat ? (tgChat.first_name ?? null) : null,
                lastName:
                    "last_name" in tgChat ? (tgChat.last_name ?? null) : null,
                isForum:
                    "is_forum" in tgChat ? (tgChat.is_forum ?? false) : false,
            },
        })
        .returning();
