...
export interface ProviderCallRecorder {
    start(input: ProviderCallStart): Promise<string | null>;
    finish(id: string, input: ProviderCallFinish): Promise<void>;
    fail(id: string, input: ProviderCallFailure): Promise<void>;
}
